        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/3">
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border border-slate-700 grayscale hover:grayscale-0 transition-all duration-500">
              <img 
                src="./autor.jpg" 
                alt="Foto do Autor - Especialista em Google" 
                className="object-cover w-full h-full"
                onError={(e) => {
                  e.currentTarget.src = "https://images.unsplash.com/photo-1556157382-97eda2d62296?q=80&w=2400&auto=format&fit=crop";
                }}
              />
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="space-y-4 text-slate-300 text-lg leading-relaxed">
              ...
              <p>
                Desenvolvi o <span className="text-amber-500 font-bold">Método Você no Topo do Google™</span> para ser o caminho definitivo que eu gostaria de ter tido quando comecei. Sem jargões técnicos complicados, sem promessas vazias. Apenas estratégia pura, aplicada e validada.
              </p>
            </div>
