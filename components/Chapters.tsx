  ...
  return (
    <div className="relative">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-base md:text-lg px-2">
              A diferença entre ser ignorado e ser a <span className="text-amber-500 font-bold">escolha número #1</span> é utilizar as <span className="text-white font-semibold">estratégias certas</span>.
            </p>
          </div>
      ...
      <div className="flex justify-center py-8 md:py-12">
        {/* MINI MOUSE COM SCROLL */}
        <div className="w-[26px] h-[40px] border-2 border-slate-600 rounded-full flex justify-center pt-2 opacity-75">
          <div className="w-1 h-2 bg-amber-500 rounded-full animate-scroll"></div>
        </div>
      </div>
