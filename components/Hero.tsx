    ...
    <div className="relative min-h-[90vh] md:min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-brand-dark">
        <img 
          ...
          className="w-full h-full object-cover opacity-30 md:opacity-40 transition-opacity duration-700"
          onError={() => {
            console.warn("Imagem header.jpg não encontrada na raiz. Usando fallback profissional.");
            setImgError(true);
          }}
        />
